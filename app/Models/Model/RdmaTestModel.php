...
class RdmaTestModel extends Model
{
    ...
    protected $fillable = ['test_identifier','test_pair_id','test_count_no','test_queue','test_queue_state','rdma_id_server','rdma_id_client','bidirection','rdma_sendbw_flag','rdma_sendbw_costtime','rdma_readbw_flag',
